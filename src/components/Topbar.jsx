...
const TITLES = {
  dashboard: 'Dashboard', applications: 'Applications', library: 'Resume library',
  templates: 'Templates', coverletters: 'Cover letters',
  billing: 'Billing', aiprefs: 'AI preferences', settings: 'Settings'
};
  ...
  return (
    <div className="topbar">
      ...
      <div className="topbar-right">
        <button className="cmdk-trigger" onClick={() => window.dispatchEvent(new Event('open-command-palette'))}>
