...
export default function CommandPalette({ setView }) {
  ...
  const commands = [
    ...
    { id: 'applications', label: 'Go to Applications', group: 'Navigate', run: () => setView('applications') },
    { id: 'library', label: 'Go to Resume library', group: 'Navigate', run: () => setView('library') },
