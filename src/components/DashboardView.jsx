...
export default function DashboardView({ state }) {
  ...
  async function handleTailor() {
    ...
    if (!activeResume) { alert('Save and activate a resume in Profile first.'); return; }
  ...
  return (
    <section>
      <h1 className="page-title">02 · Dashboard</h1>
      ...
      <div className="dash-grid">
        ...
        <div>
          <div className="panel">
            ...
            {tailoring && <div className="loading"><span className="spinner"></span> Tailoring against the JD...</div>}
          ...
          <div className="panel">
            ...
            <div className="row-card"><div className="row-main"><div className="row-icon">●</div>
              <div className="row-title">{activeResume ? activeResume.label : 'No resume active — set one in Profile'}</div></div></div>
