...
const ICONS = {
  ...
  applications: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="16" rx="2" /><path d="M8 2v4M16 2v4M3 10h18" /></svg>,
  ...
  templates: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2" /><path d="M3 9h18M9 21V9" /></svg>,
  coverletters: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16v16H4z" /><path d="m4 6 8 7 8-7" /></svg>,
  ...
  aiprefs: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2 2 7l10 5 10-5-10-5z" /><path d="M2 17l10 5 10-5M2 12l10 5 10-5" /></svg>,
...
const ACCOUNT_NAV = [
  ...
  { key: 'aiprefs', label: 'AI preferences' },
  ...
  return (
    <aside className="side">
      ...
      <div className="side-foot">
        ...
        <div style={{ textAlign: 'center', fontFamily: 'var(--mono)', fontSize: '9.5px', color: 'var(--dim)', letterSpacing: '.06em' }}>v2.0.0</div>
      </div>
    </aside>
  );
}
