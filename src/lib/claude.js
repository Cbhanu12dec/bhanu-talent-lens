...
export async function tailorResume({ jdText, resumeText, gaps, prompts, atsTarget, mode, intensity, aggressiveness, keywordDensity, bulletLength, lockedSections }) {
  try {
    const { json, creditsRemaining } = await proxy('tailor', { jdText, resumeText, gaps, prompts, atsTarget, mode, intensity, aggressiveness, keywordDensity, bulletLength, lockedSections });
