...
export async function tailorResume({ jdText, resumeText, gaps, prompts, atsTarget, mode, aggressiveness, keywordDensity, bulletLength, lockedSections }) {
  try {
    const { json, creditsRemaining } = await proxy('tailor', { jdText, resumeText, gaps, prompts, atsTarget, mode, aggressiveness, keywordDensity, bulletLength, lockedSections });
